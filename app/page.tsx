...
export default function Home() {
  ...
  const jsonLd = {
    ...
    "@id": "https://ryzq.dev",
    name: "Ryzq Digital",
    description: "Agence digitale spécialisée en développement web, applications mobiles et design UI/UX à Bruxelles",
    url: "https://ryzq.dev",
    telephone: "+32470886024",
    email: "hello@ryzq.dev",
    address: {
      "@type": "PostalAddress",

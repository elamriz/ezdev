        ...
        <main className="min-h-screen bg-background selection:bg-foreground selection:text-background transition-colors duration-300 py-32 px-8">
            <div className="max-w-4xl mx-auto space-y-16">
                ...
                <div className="space-y-6">
                    <Link
                        href="/"
                        className="inline-flex items-center gap-2 text-neutral-500 hover:text-foreground transition-colors"
                    >
                        <ArrowLeft size={20} />
                        ...
                        >
                            <article className="space-y-4 border-b border-neutral-200 dark:border-neutral-800 pb-12 transition-colors hover:border-foreground">
                                ...
                                <div className="flex items-center gap-4">
                                    {/* Thumbnail image */}
                                    {post.image && (
                                        <div className="relative w-14 h-14 rounded-xl overflow-hidden flex-shrink-0 border border-neutral-200 dark:border-neutral-700 shadow-sm group-hover:shadow-md transition-shadow">
                                            <Image
                                                src={post.image}
